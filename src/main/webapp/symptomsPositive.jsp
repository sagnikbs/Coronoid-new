        ...
        <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                PERSONS WITH SYMPTOMS POSITIVE
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                    <c:forEach items="${symptomsPositive}" var="positive" varStatus="loop">
                                        <tr>
                                        	<td>${loop.index+1}</td>
                                        	<td>${positive.name}</td>
                                        	<td>${positive.loginId}</td>
                                        	<td>${positive.phone}</td>
                                        	<td>${positive.temp}</td>
                                            <td><a href="<c:url value="trackPerson/${positive.loginId}"/>"><button class="btn btn-success waves-effect">Track</button></a></td>
                                        </tr>
                                 </c:forEach>
                                    </tbody>
