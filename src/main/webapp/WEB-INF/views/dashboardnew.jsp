...
<form action="dashboardnew" method="post">  
<div style="display:none">
<input id="currentPosition" type="text" class="form-control" placeholder="" name="currentPosition"/>
</div>
<input type="submit" class="btn btn-link waves-effect" value="CLOSE"/>
</form>                
